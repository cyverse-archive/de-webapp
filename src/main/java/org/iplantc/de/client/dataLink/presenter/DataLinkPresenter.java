...
public class DataLinkPresenter<M extends DiskResource> implements DataLinkPanel.Presenter<M> {
    ...
    private final DiskResourceServiceFacade drService = new DiskResourceServiceFacadeImpl();
    ...
    private void getExistingDataLinks(List<M> resources) {
        ...
        // drService.listDataLinks(DataUtils.getDiskResourceIdList(resources), new
        // ListDataLinksCallback(view.getTree()));
    ...
    public void deleteDataLink(DataLink value) {
        // drService.deleteDataLinks(Lists.newArrayList(value.getId()), new
        // DeleteDataLinksCallback(view.getTree()));
    }
