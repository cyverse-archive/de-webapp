...
public class TextViewPagingToolBar extends ToolBar {
	...
	private void initPageSizeSlider() {
		pageSize = new Slider();
		pageSize.setMinValue(TextViewerImpl.MIN_PAGE_SIZE_KB);
		pageSize.setMaxValue(TextViewerImpl.MAX_PAGE_SIZE_KB);
		pageSize.setIncrement(TextViewerImpl.PAGE_INCREMENT_SIZE_KB);
		pageSize.setValue(TextViewerImpl.MIN_PAGE_SIZE_KB);
